...
public class MoviesFilterDTO
{
    ...
    {
        var page = context.ExtractValueOrDefault(nameof(Page), 1);
        var recordsPerPage = context.ExtractValueOrDefault(nameof(RecordsPerPage), 10);
        ...
        var filter = new MoviesFilterDTO
        {
            Page = page,
